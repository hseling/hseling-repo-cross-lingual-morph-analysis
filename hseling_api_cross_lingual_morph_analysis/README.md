...
Cross-lingual morphological analysis description
...
## Development environment and release process
 ...
 - create virtualenv with Flask and Cross-lingual morphological analysis installed into it (latter is installed in
...
install it (`pip install hseling_api_cross_lingual_morph_analysis.tar.gz`), ensure that configuration file exists and
`HSELING_API_CROSS_LINGUAL_MORPH_ANALYSIS_SETTINGS` environment variable points to it, ensure that user has access to the
